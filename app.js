...
function Store(location, min_customer, max_customer, avg_cookie_per_customer){
    ...
    this.hourlyCustomers = getRandomInt(this.min_customer,this.max_customer);
    this.hourlySales = this.avg_cookie_per_customer;
    this.render = function (domReference){
        ...
        for (var timeIndex = 0; timeIndex < timeOfDay.length; timeIndex++){
            var hourlyCookies = getRandomInt(this.min_customer,this.max_customer)*this.hourlySales
